    ...
    def request_full_symbol_tree(self, within_relative_path: str | None = None) -> list[ls_types.UnifiedSymbolInformation]:
        ...
        if within_relative_path:
            ...
            if self.is_ignored_path(within_relative_path):
                # Fork policy: an explicitly requested path is processed even when ignored (warn, don't raise).
                log.warning(
                    "Path %s is ignored by ignore patterns but was explicitly requested; proceeding anyway.",
